        ...
        <footer id="footer">
            ...
            <div className="footer-cta">
                <p className="footer-cta__text">
                    Your Everyday Lifestyle Companion
                </p>
            ...
            <div className="footer-main">
                ...
                <div className="footer-info">
                    ...
                    <nav className="footer-nav" aria-label="Footer navigation">
                        ...
                        <Link href="/" className="footer-nav__link">About Us</Link>
                        <Link href="/" className="footer-nav__link">Solutions</Link>
                        <Link href="/" className="footer-nav__link">Resources</Link>
                        <Link href="/" className="footer-nav__link">Testimonials</Link>
                    </nav>
                    ...
                    <div className="footer-legal">
                        <Link href="/" className="footer-legal__link">Privacy Policy</Link>
                        <Link href="/" className="footer-legal__link">Terms &amp; Conditions</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="footer-bottom">
                ...
                <div className="footer-bottom__socials">
                    ...
                    {/* Instagram */}
                    <a href="https://www.instagram.com/thesuperbae/" target="_blank" rel="noopener noreferrer" className="footer-bottom__social-link" aria-label="Instagram">
                        <svg viewBox="0 0 24 24">
